...
function toggleLanguage() {
    ...
    if (currentLang === "en") {
        ...
        if(resumeLink) {
            resumeLink.href = "public/curriculo_enBR.pdf";
            resumeLink.download = "Resume_Gabriel_Tertuliano_EN.pdf";
        }
    } else {
        ...
        if(resumeLink) {
            resumeLink.href = "public/curriculo_ptBR.pdf";
            resumeLink.download = "Curriculo_Gabriel_Tertuliano_PT.pdf";
        }
    }
